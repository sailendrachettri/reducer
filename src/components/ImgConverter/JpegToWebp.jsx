        ...
        <main>
            <div className='container'>
                <form onSubmit={handleFileResize}>
                    <h3>Convert your JPEG image into WEBP in seconds</h3>
                    <label htmlFor='upload-file'>
                        <span className="material-symbols-outlined"> add_photo_alternate  </span>
                        <p> {inputFileName ? inputFileName : "upload your image here"}</p>
                    </label>
                    <input type="file" accept="image/jpeg" id='upload-file'
                ...
                {isUploaded &&
                    <div className='complected'>
                        <a download={`converted_${filename}.webp`} href={newImage}>
                            <p>Download your webp image file :)</p>
