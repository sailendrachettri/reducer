        ...
        <main>
            <div className='container'>
                <form onSubmit={handleFileResize}>
                    <h3>Convert your JPEG image into PNG in seconds</h3>
                ...
                {isUploaded &&
                    <div className='complected'>
                        <a download={`converted_${filename}.png`} href={newImage}>
                            <p>Download your png image file :)</p>
